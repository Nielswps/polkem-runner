...
pub mod api {
    ...
    impl ::subxt::events::RootEvent for Event {
        fn root_event(
            ...
            if pallet_name == "ParachainSystem" {
                return Ok(Event::ParachainSystem(
                    parachain_system::Event::decode_with_metadata(
                        &mut &*pallet_bytes,
                        pallet_ty,
                        metadata,
                    )?,
            ...
            if pallet_name == "PolkadotXcm" {
                return Ok(Event::PolkadotXcm(
                    polkadot_xcm::Event::decode_with_metadata(
                        &mut &*pallet_bytes,
                        pallet_ty,
                        metadata,
                    )?,
            ...
            if pallet_name == "Energychain" {
                return Ok(Event::Energychain(
                    energychain::Event::decode_with_metadata(
                        &mut &*pallet_bytes,
                        pallet_ty,
                        metadata,
                    )?,
    ...
    impl ConstantsApi {
        ...
        pub fn energychain(&self) -> energychain::constants::ConstantsApi {
            energychain::constants::ConstantsApi
        }
    }
    ...
    impl StorageApi {
        ...
        pub fn energychain(&self) -> energychain::storage::StorageApi {
            energychain::storage::StorageApi
        }
    }
    ...
    impl TransactionApi {
        ...
        pub fn energychain(&self) -> energychain::calls::TransactionApi {
            energychain::calls::TransactionApi
        }
    }
            ...
            impl StorageApi {
                ...
                pub fn events(
                    ...
                    ::std::vec::Vec<
                        runtime_types::frame_system::EventRecord<
                            runtime_types::parachain_energychain_runtime::RuntimeEvent,
                            ::subxt::utils::H256,
                        >,
                    >,
                    ::subxt::storage::address::Yes,
                ...
                > {
                    ::subxt::storage::address::Address::new_static(
                        ...
                        vec![],
                        [
                            91u8, 90u8, 146u8, 71u8, 165u8, 31u8, 9u8, 62u8, 84u8, 222u8, 160u8,
                            38u8, 203u8, 75u8, 166u8, 246u8, 86u8, 29u8, 178u8, 41u8, 14u8, 150u8,
                            235u8, 42u8, 152u8, 194u8, 245u8, 202u8, 94u8, 8u8, 230u8, 221u8,
                        ],
                    )
                }
    ...
    pub mod session {
        ...
        pub mod calls {
            ...
            #[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
            pub struct SetKeys {
                pub keys: runtime_types::parachain_energychain_runtime::SessionKeys,
            ...
            impl TransactionApi {
                ...
                pub fn set_keys(
                    &self,
                    keys: runtime_types::parachain_energychain_runtime::SessionKeys,
        ...
        pub mod storage {
            ...
            impl StorageApi {
                ...
                pub fn queued_keys(
                    ...
                    ::std::vec::Vec<(
                        ::subxt::utils::AccountId32,
                        runtime_types::parachain_energychain_runtime::SessionKeys,
                    )>,
                    ::subxt::storage::address::Yes,
                    ::subxt::storage::address::Yes,
                    (),
            ...
            impl TransactionApi {
                pub fn send(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            168u8, 70u8, 62u8, 185u8, 94u8, 61u8, 14u8, 0u8, 93u8, 35u8, 139u8,
                            25u8, 248u8, 58u8, 137u8, 193u8, 144u8, 60u8, 7u8, 67u8, 251u8, 142u8,
                            136u8, 218u8, 239u8, 179u8, 14u8, 14u8, 242u8, 194u8, 36u8, 252u8,
                        ],
                    )
                }
                ...
                pub fn teleport_assets(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            88u8, 191u8, 199u8, 6u8, 68u8, 121u8, 210u8, 111u8, 81u8, 140u8, 253u8,
                            27u8, 250u8, 41u8, 60u8, 226u8, 48u8, 233u8, 36u8, 163u8, 21u8, 235u8,
                            194u8, 229u8, 218u8, 138u8, 127u8, 118u8, 197u8, 198u8, 6u8, 224u8,
                        ],
                    )
                }
                ...
                pub fn reserve_transfer_assets(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            156u8, 154u8, 181u8, 135u8, 254u8, 28u8, 184u8, 249u8, 230u8, 142u8,
                            151u8, 101u8, 204u8, 124u8, 179u8, 225u8, 205u8, 18u8, 80u8, 108u8,
                            39u8, 154u8, 226u8, 20u8, 85u8, 60u8, 128u8, 201u8, 44u8, 128u8, 121u8,
                            31u8,
                        ],
                    )
                }
                ...
                pub fn execute(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            98u8, 139u8, 105u8, 116u8, 49u8, 171u8, 112u8, 83u8, 115u8, 215u8,
                            32u8, 123u8, 123u8, 247u8, 200u8, 16u8, 101u8, 122u8, 98u8, 192u8,
                            205u8, 50u8, 158u8, 210u8, 10u8, 178u8, 107u8, 166u8, 202u8, 42u8,
                            81u8, 119u8,
                        ],
                    )
                }
                ...
                pub fn force_xcm_version(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            16u8, 250u8, 236u8, 65u8, 112u8, 162u8, 67u8, 169u8, 200u8, 81u8,
                            108u8, 120u8, 0u8, 151u8, 124u8, 156u8, 163u8, 5u8, 78u8, 224u8, 33u8,
                            95u8, 147u8, 95u8, 93u8, 47u8, 113u8, 192u8, 176u8, 213u8, 212u8, 70u8,
                        ],
                    )
                }
                ...
                pub fn force_subscribe_version_notify(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            126u8, 205u8, 44u8, 106u8, 164u8, 1u8, 201u8, 23u8, 18u8, 58u8, 147u8,
                            120u8, 159u8, 106u8, 138u8, 181u8, 124u8, 225u8, 192u8, 48u8, 140u8,
                            234u8, 40u8, 163u8, 92u8, 120u8, 242u8, 241u8, 33u8, 87u8, 147u8,
                            107u8,
                        ],
                    )
                }
                ...
                pub fn force_unsubscribe_version_notify(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            13u8, 0u8, 152u8, 206u8, 189u8, 7u8, 246u8, 160u8, 101u8, 181u8, 226u8,
                            28u8, 215u8, 159u8, 41u8, 173u8, 137u8, 247u8, 118u8, 104u8, 156u8,
                            96u8, 132u8, 174u8, 142u8, 242u8, 9u8, 191u8, 211u8, 56u8, 136u8, 13u8,
                        ],
                    )
                }
                #[doc = "Transfer some assets from the local chain to the sovereign account of a destination"]
                ...
                pub fn limited_reserve_transfer_assets(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            61u8, 135u8, 117u8, 192u8, 102u8, 72u8, 254u8, 1u8, 157u8, 26u8, 131u8,
                            233u8, 183u8, 156u8, 244u8, 23u8, 102u8, 2u8, 142u8, 162u8, 39u8,
                            107u8, 39u8, 72u8, 14u8, 45u8, 144u8, 211u8, 87u8, 140u8, 99u8, 178u8,
                        ],
                    )
                }
                #[doc = "Teleport some assets from the local chain to some destination chain."]
                ...
                pub fn limited_teleport_assets(
                    ...
                    ::subxt::tx::Payload::new_static(
                        ...
                        [
                            210u8, 166u8, 12u8, 52u8, 29u8, 5u8, 29u8, 94u8, 199u8, 142u8, 56u8,
                            243u8, 121u8, 29u8, 121u8, 238u8, 110u8, 206u8, 147u8, 170u8, 50u8,
                            223u8, 63u8, 71u8, 239u8, 216u8, 217u8, 67u8, 105u8, 79u8, 202u8, 30u8,
                        ],
                    )
                }
            }
    ...
    pub mod energychain {
        ...
        pub mod calls {
            ...
            #[decode_as_type(crate_path = ":: subxt :: ext :: scale_decode")]
            #[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
            pub struct CreateEnergyRequest {
                pub amount: ::core::primitive::u16,
                pub price: ::core::primitive::u8,
            }
            pub struct TransactionApi;
            impl TransactionApi {
                ...
                ) -> ::subxt::tx::Payload<CreateEnergyOffer> {
                    ::subxt::tx::Payload::new_static(
                        "Energychain",
                        "create_energy_offer",
                        CreateEnergyOffer { amount, price },
                        [
                            214u8, 178u8, 230u8, 193u8, 123u8, 41u8, 141u8, 242u8, 185u8, 204u8,
                            221u8, 19u8, 160u8, 220u8, 63u8, 110u8, 194u8, 78u8, 22u8, 233u8,
                            188u8, 247u8, 21u8, 136u8, 114u8, 18u8, 89u8, 114u8, 4u8, 17u8, 10u8,
                            32u8,
                        ],
                    )
                }
                pub fn create_energy_request(
                    &self,
                    amount: ::core::primitive::u16,
                    price: ::core::primitive::u8,
                ) -> ::subxt::tx::Payload<CreateEnergyRequest> {
                    ::subxt::tx::Payload::new_static(
                        "Energychain",
                        "create_energy_request",
                        CreateEnergyRequest { amount, price },
                        [
        ...
        #[doc = "\n\t\t\tThe [event](https://docs.substrate.io/main-docs/build/events-errors/) emitted\n\t\t\tby this pallet.\n\t\t\t"]
        pub type Event = runtime_types::pallet_energychain::pallet::Event;
        pub mod events {
            use super::runtime_types;
            #[derive(
                :: subxt :: ext :: codec :: Decode,
            ...
            pub struct EnergyOfferCreated(
                pub ::core::primitive::u16,
                pub ::core::primitive::u8,
                pub ::subxt::utils::AccountId32,
                pub ::subxt::utils::H256,
            );
            impl ::subxt::events::StaticEvent for EnergyOfferCreated {
                const PALLET: &'static str = "Energychain";
                const EVENT: &'static str = "EnergyOfferCreated";
            }
            #[derive(
                :: subxt :: ext :: codec :: Decode,
                :: subxt :: ext :: codec :: Encode,
            ...
            #[decode_as_type(crate_path = ":: subxt :: ext :: scale_decode")]
            #[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
            pub struct EnergyRequestCreated(
                pub ::core::primitive::u16,
                pub ::core::primitive::u8,
                pub ::subxt::utils::AccountId32,
                pub ::subxt::utils::H256,
            );
            impl ::subxt::events::StaticEvent for EnergyRequestCreated {
                const PALLET: &'static str = "Energychain";
                const EVENT: &'static str = "EnergyRequestCreated";
            }
            #[derive(
                :: subxt :: ext :: codec :: Decode,
                :: subxt :: ext :: codec :: Encode,
            ...
            impl ::subxt::events::StaticEvent for EnergyTradeCreated {
                const PALLET: &'static str = "Energychain";
                const EVENT: &'static str = "EnergyTradeCreated";
            }
        }
        pub mod storage {
            use super::runtime_types;
            ...
            impl StorageApi {
                ...
                pub fn energy_offers(
                    ...
                    ::subxt::storage::address::StaticStorageMapKey,
                    runtime_types::pallet_energychain::pallet::EnergyOffer,
                    ::subxt::storage::address::Yes,
                    (),
                    ::subxt::storage::address::Yes,
                > {
                    ::subxt::storage::address::Address::new_static(
                        ...
                        [
                            200u8, 143u8, 181u8, 200u8, 72u8, 110u8, 194u8, 50u8, 211u8, 0u8,
                            151u8, 213u8, 80u8, 249u8, 72u8, 80u8, 235u8, 21u8, 112u8, 183u8, 51u8,
                            222u8, 247u8, 13u8, 242u8, 153u8, 214u8, 37u8, 17u8, 232u8, 119u8,
                            160u8,
                        ],
                    )
                }
                ...
                pub fn energy_requests(
                    ...
                    ::subxt::storage::address::StaticStorageMapKey,
                    runtime_types::pallet_energychain::pallet::EnergyRequest,
                    ::subxt::storage::address::Yes,
                    (),
                    ::subxt::storage::address::Yes,
                > {
                    ::subxt::storage::address::Address::new_static(
                        ...
                        [
                            203u8, 45u8, 186u8, 162u8, 96u8, 115u8, 50u8, 75u8, 1u8, 34u8, 139u8,
                            172u8, 143u8, 166u8, 188u8, 191u8, 68u8, 253u8, 130u8, 110u8, 58u8,
                            66u8, 133u8, 135u8, 45u8, 238u8, 70u8, 229u8, 108u8, 77u8, 195u8,
                            207u8,
                        ],
                    )
                }
                ...
                #[doc = " Storage Map for EnergyOffer by seller Id (Hash) to a EnergyOffer"]
                pub fn energy_trades(
                    &self,
                    _0: impl ::std::borrow::Borrow<::subxt::utils::H256>,
                ) -> ::subxt::storage::address::Address<
                    ::subxt::storage::address::StaticStorageMapKey,
                    runtime_types::pallet_energychain::pallet::EnergyTrade,
                    ::subxt::storage::address::Yes,
                    (),
                    ::subxt::storage::address::Yes,
                > {
                    ::subxt::storage::address::Address::new_static(
                        ...
                        [
                            196u8, 241u8, 11u8, 177u8, 147u8, 184u8, 78u8, 89u8, 148u8, 200u8,
                            197u8, 158u8, 123u8, 15u8, 95u8, 55u8, 150u8, 95u8, 149u8, 16u8, 229u8,
                            223u8, 147u8, 161u8, 238u8, 207u8, 196u8, 208u8, 160u8, 129u8, 182u8,
                            51u8,
                        ],
                    )
                }
                #[doc = " Storage Map for EnergyOffer by seller Id (Hash) to a EnergyOffer"]
                pub fn energy_trades_root(
                    &self,
                ) -> ::subxt::storage::address::Address<
                    ::subxt::storage::address::StaticStorageMapKey,
                    runtime_types::pallet_energychain::pallet::EnergyTrade,
        ...
        pub mod constants {
            ...
            impl ConstantsApi {
                ...
                pub fn base_price(&self) -> ::subxt::constants::Address<::core::primitive::u8> {
                    ::subxt::constants::Address::new_static(
                        "Energychain",
                        "BasePrice",
                        [
    ...
    pub mod runtime_types {
        ...
        pub mod pallet_energychain {
            ...
            pub mod pallet {
                ...
                pub enum Error {
                    ...
                    StorageOverflow,
                    #[codec(index = 2)]
                    EnergyOfferNotEnoughWatts,
                    #[codec(index = 3)]
                    EnergyRequestNotEnoughWatts,
                }
                #[derive(
                    :: subxt :: ext :: codec :: Decode,
                    :: subxt :: ext :: codec :: Encode,
        ...
        pub mod parachain_energychain_runtime {
            use super::runtime_types;
            #[derive(
                :: subxt :: ext :: codec :: Decode,
                :: subxt :: ext :: codec :: Encode,
            ...
            pub enum RuntimeCall {
                ...
                #[codec(index = 40)]
                Energychain(runtime_types::pallet_energychain::pallet::Call),
            }
            #[derive(
                :: subxt :: ext :: codec :: Decode,
                :: subxt :: ext :: codec :: Encode,
            ...
            pub enum RuntimeEvent {
                ...
                #[codec(index = 40)]
                Energychain(runtime_types::pallet_energychain::pallet::Event),
            }
            #[derive(
                :: subxt :: ext :: codec :: Decode,
                :: subxt :: ext :: codec :: Encode,
